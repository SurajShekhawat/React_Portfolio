export const Bio = {
  ...
  facebook: "https://www.facebook.com/suraj.shekhawat.754365/",
};
...
export const projects = [
  {
    ...
    description:
      "Developed a ReactJs web application that allows users to search for, play, and pause their favorite podcasts on demand and create podcasts. Implemented user authentication using Google Auth and Jwt Auth, made responsive user interface with React JS that provides users with a seamless experience across all devices. Practiced agile methodologies to optimize team efficiency and communication.",
    image:
      "https://drive.google.com/uc?export=view&id=1kORfPitJUj1PON8znPpFf1lNbo0vBzbB",
      // "https://drive.google.com/file/d/1kORfPitJUj1PON8znPpFf1lNbo0vBzbB/view?usp=sharing",
    tags: ["React Js", "Spotify API", "Node Js", "Taliwind Css", "Styled Component"],
    category: "web app",
    github: "https://github.com/SurajShekhawat/React_Spotify_Clone",
    webapp: "https://spotify-clone-tan.netlify.app/",
    member: [
      {
        name: "Suraj Singh Shekhawat",
  ...
  },
  {
    ...
    date: "Oct 2023",
    description:
      "Designed and developed the RactJS project, This is simple web app and only usefull content copy, uppercase, lowercase, copytext and dark mode functionalty in this app.",
    image:
      "https://drive.google.com/uc?export=view&id=19fUjeAOAHPJPNnMwXilCpGQcwPNQeFEA",
    tags: [
      "React Js",
      "Node Js"
    ],
    category: "web app",
    github: "https://github.com/SurajShekhawat/React_TextUtils",
    webapp: "https://my-textutil-tan.netlify.app/",
    member: [
      {
        name: "Suraj Singh Shekhawat",
        img: "https://drive.google.com/uc?export=view&id=1OHecdr8bKYoADiXeUnPTCLC5-mkvNvdM",
  ...
  },
  {
    ...
    image:
      "https://drive.google.com/uc?export=view&id=1sYQs1ZMGtBxWp753fGv9YvoQMTHzjFkg",
    tags: [
      "React Js",
      "Node Js",
      "API"
    ...
    category: "web app",
    github: "https://github.com/SurajShekhawat/YouTube_Clone",
    webapp: "https://youtube-clone-tan.netlify.app/",
    member: [
      {
        name: "Suraj Singh Shekhawat",
        img: "https://drive.google.com/uc?export=view&id=1OHecdr8bKYoADiXeUnPTCLC5-mkvNvdM",
  ...
  },
  {
    ...
    description:
      "Designed and developed the RactJS project, This is Advance Project This project is exectly copy of youtube but some reson is api is not work of this web app.",
    image:
      "https://drive.google.com/uc?export=view&id=1k6bZTukx8Zv6wLup9m8QAS5kiXIL3sIH",
    tags: [
      "Html",
      "Css",
      "Java Script",
